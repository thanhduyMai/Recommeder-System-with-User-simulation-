...
def main():
	...
	# Path
    recs_path = "hdfs:///DATALAKE/MyData/predictions/deepfm_topk.parquet"

    print(f"📥 Loading DeepFM Recs from: {recs_path}")
    try:
        ...
        df_recs.write.format("org.elasticsearch.spark.sql") \
            .option("es.resource", "recommendations/_doc") \
        ...
        print("✅ SUCCESS: DeepFM Recs pushed correctly!")
